...
DATASET          = "gdb13_1K"          # dataset name in "./data/pre-training/"
...
JOBNAME          = "AttS2V"            # used to create a sub directory
...
# set paths here
HOME             = str(Path.home())
PYTHON_PATH      = f"{HOME}/anaconda3/envs/graphinvent/bin/python"
...
params = {
    ...
    "init_lr"      : 1e-4,
    "epochs"       : 400,
    "batch_size"   : 100, # change back to 1000
    "block_size"   : 100000,
    "device"       : DEVICE,
