...
class AggregationMPNN(torch.nn.Module):
    ...
    def forward(self, nodes : torch.Tensor, edges : torch.Tensor) -> torch.Tensor:
        ...
        # Debug: Print shape of adjacency
        ...
        # Debug: Print shapes of indices
        print(f"Shapes of edge indices: {edge_batch_batch_idc.shape}, {edge_batch_node_idc.shape}, {edge_batch_nghb_idc.shape}")
        print(f"Shapes of node batch indices: {node_batch_batch_idc.shape}, {node_batch_node_idc.shape}")
        ...
        # Debug: Print node batch size, node degrees, and max node degree
        print(f"Node batch size: {node_batch_size}, Max node degree: {max_node_degree}")
        ...
        # Debug: Print shapes of the tensors just before assignment
        print(f"Shape of node_batch_edges just before assignment: {node_batch_edges.shape}")
        expected_shape = node_batch_edges[edge_batch_node_batch_idc, node_batch_nghb_nghb_idc, :].shape
        actual_shape = edges[edge_batch_batch_idc, edge_batch_node_idc, edge_batch_nghb_idc, :].shape
        print(f"Expected shape (from node_batch_edges indexing): {expected_shape}")
        print(f"Actual shape (from edges selection): {actual_shape}")
